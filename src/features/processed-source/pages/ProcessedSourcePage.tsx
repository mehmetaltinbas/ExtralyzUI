...
export function ProcessedSourcePage({ processedSource, className }: {
    processedSource: ProcessedSource;
    className?: string;
}) {
    return (
        <div className={`w-full h-auto flex flex-col justify-center items-center gap-4 p-4 ${className ?? ''}`}>
