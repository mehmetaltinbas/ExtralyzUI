...
export function ProcessedSourceCard({ processedSource, fetchProcessedSources }: {
    processedSource: ProcessedSource;
    fetchProcessedSources: () => void
}) {

    async function deleteProcessedSource(event: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
        ...
        <div className='h-full flex justify-center items-center'>
            <div className='w-[250px] h-[150px] border flex flex-col'>
                <div className='w-full h-[50px] flex justify-center items-center gap-1'>
                    ...
                    <ClaretButton onClick={deleteProcessedSource}>
                        Delete
                    </ClaretButton>
                </div>
