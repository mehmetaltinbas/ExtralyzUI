...
export function ProcessedSourceActionMenu({ isHidden, setIsHidden, processedSourceId, fetchProcessedSources, toggleCreateExerciseSetForm, toggleDeleteApproval }: {
    isHidden: boolean;
    ...
    return (
        <div id="processed-source-action-menu"
