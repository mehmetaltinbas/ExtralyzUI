...
export function OpenEndedExerciseEvaluationCard({ exercise, evaluation, index }: {
    exercise: Exercise;
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-1">
            <p><span className="font-serif">Your answer</span>: <span className="text-gray-300">{evaluation.userAnswer}</span></p>
            <p><span className="font-serif">Correct answer</span>: <span className="text-green-900">${exercise.solution}</span></p>
